...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="x_panel ">
            <div class="x_title">
                <h2>Relacionamento Matérias / Turma </h2>
                <div class="clearfix"></div>
            </div><!-- /.box-header -->
            <!-- form start -->
            <form id="form-relacionamento-at" class="form-horizontal" method="post"
                  action="{{ url('gestor/materias-turma/create') }}"
                  autocomplete="off">
                ...
                <div class="">
                    <a href="{{ url('/admin/turmas') }}" class="btn btn-sm btn-danger close_popup">
        ...
        $(document).ready(function(){
            ...
            $("#turma_id").on('change', function () {
                ...
                if(idTurma != "") {
                    $.ajax({
                    dataType: "json",
                    url: "{{url('gestor/materias-turma/1/materias')}}".replace("1", idTurma),
