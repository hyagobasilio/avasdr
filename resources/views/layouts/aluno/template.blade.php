        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="" class="site_title"><i class="fa fa-paw"></i> <span>AVA SDR!</span></a>
            </div>
            ...
            <div class="profile">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>{{ auth()->guard('aluno')->user()->name }}</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
            ...
            @include('layouts.aluno.sidemenu')

            
          </div>
        </div>

        @include('layouts.aluno.top-navegation')
